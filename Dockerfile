...
# 1. Declare build arguments and set them as environment variables
...
ARG VITE_DASHBOARD_OWNER_MANAGEMENT_URL
ENV VITE_DASHBOARD_OWNER_MANAGEMENT_URL=${VITE_DASHBOARD_OWNER_MANAGEMENT_URL}

ARG VITE_DASHBOARD_TENANT_MANAGEMENT_URL
ENV VITE_DASHBOARD_TENANT_MANAGEMENT_URL=${VITE_DASHBOARD_TENANT_MANAGEMENT_URL}
...
ARG VITE_TENANT_LIST_EVENT_URL
ENV VITE_TENANT_LIST_EVENT_URL=${VITE_TENANT_LIST_EVENT_URL}
