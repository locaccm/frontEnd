...
import { Lease, LeasePayload } from "../../types/housingManagement/housingManagement.js";
...
const createLease = useCallback(async (payload: Omit<LeasePayload, "USEN_ID">): Promise<boolean> => {
  const userId = getUserId();
