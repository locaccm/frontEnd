...
const CreateAccommodationModal = ({ onClose, onSuccess }) => {
    ...
    return (_jsxs("div", { style: modalStyle, children: [_jsx("h2", { children: "Cr\u00E9er un logement" }), _jsx(AccommodationForm, { onSubmit: handleCreate, onCancel: onClose })] }));
};
const modalStyle = {
    position: "fixed",
    top: "10%",
