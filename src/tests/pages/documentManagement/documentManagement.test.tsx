...
} from "../../../pages/documentManagement/documentManagement.js";
import {
  DocumentInfo,
  fetchDocuments,
} from "../../../core/api/documentManagement/getDocument.js";
...
describe("DocumentManagement", () => {
  ...
  it("génère la quittance et liste les documents obtenus", async () => {
    mockedGenerateReceipt.mockResolvedValue({
      pdfUrl: "https://exemple/doc.pdf",
    });
