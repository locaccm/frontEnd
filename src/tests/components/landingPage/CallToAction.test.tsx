...
describe('CallToAction', () => {
  it('affiche le titre principal', () => {
    render(<CallToAction />);
    expect(screen.getByText(/Optimisez la gestion de vos biens immobiliers/i)).toBeInTheDocument();
  });
  ...
  it('affiche le bouton Créez votre compte', () => {
    render(<CallToAction />);
    expect(screen.getByRole('button', { name: /Créez votre compte/i })).toBeInTheDocument();
  });
});
