...
describe("ServicesSection component", () => {
  it("renders the main section headline", () => {
    ...
    expect(
      screen.getByText(
        /Optimisez la gestion de vos biens immobiliers avec nos services/i,
      ),
    ).toBeInTheDocument();
  });
  ...
  it("renders the large image with correct alt text", () => {
    ...
    expect(screen.getByAltText("Gestion locative")).toBeInTheDocument();
  });
  ...
  it("renders both service description paragraphs", () => {
    ...
    expect(
      screen.getByText(
        /Nous proposons une solution complète pour gérer vos biens/i,
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        /Notre plateforme intuitive vous permet de gérer vos biens en toute simplicité/i,
      ),
    ).toBeInTheDocument();
  });
  ...
  it("renders the call-to-action button", () => {
    ...
    expect(
      screen.getByRole("button", {
        name: /Commencez à gérer vos biens dès maintenant/i,
      }),
    ).toBeInTheDocument();
  });
});
