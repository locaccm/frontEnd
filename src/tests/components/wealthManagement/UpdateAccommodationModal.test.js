...
describe("UpdateAccommodationModal", () => {
    ...
    it("display modal form with initial data value ", () => {
        render(_jsx(UpdateAccommodationModal, { onClose: () => { }, accommodationId: 1, initialData: mockData }));
    ...
    it("call updateAccommodation, onSuccess and onClose if success", async () => {
        ...
        render(_jsx(UpdateAccommodationModal, { onClose: onClose, onSuccess: onSuccess, accommodationId: 99, initialData: mockData }));
    ...
    it("cancel the update and only call onClose", () => {
        const onClose = vi.fn();
        render(_jsx(UpdateAccommodationModal, { onClose: onClose, accommodationId: 5, initialData: mockData }));
