...
describe("DeleteConfirmationModal", () => {
    ...
    it("Dont display if isOpen false", () => {
        const { container } = render(_jsx(DeleteConfirmationModal, { isOpen: false, onClose: () => { }, accommodationId: 1 }));
        expect(container.firstChild).toBeNull();
    });
    it("display if isOpen true", () => {
        render(_jsx(DeleteConfirmationModal, { isOpen: true, onClose: () => { }, accommodationId: 1 }));
    ...
    it("call deleteAccommodation, onSuccess and onClose if delete is sucessful", async () => {
        ...
        render(_jsx(DeleteConfirmationModal, { isOpen: true, onClose: onClose, accommodationId: 42, onSuccess: onSuccess }));
    ...
    it("call only onClose if Annuler button is click", () => {
        const onClose = vi.fn();
        render(_jsx(DeleteConfirmationModal, { isOpen: true, onClose: onClose, accommodationId: 99 }));
