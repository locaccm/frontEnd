...
const { getUserId, getToken, getEmail, getUserProfileData, setUserProfileData, initUserProfileSession, } = sessionManager;
...
describe("sessionManager", () => {
    ...
    it("initUserProfileSession fetches and stores data", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith(expect.stringContaining("/profiles/1"), expect.objectContaining({
